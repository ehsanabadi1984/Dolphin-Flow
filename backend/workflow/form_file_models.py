...
class FormFile(models.Model):
    ...
    # Empty for a top-level field. For a NORMAL repeatable group this
    # contains the stable row _id stored alongside the row in FormData.data.
    ...
    file = models.FileField(
        upload_to=workflow_form_file_upload_to,
    )
