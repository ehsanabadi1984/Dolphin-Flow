...
from workflow.users_organization_workspace import users_organization_workspace
...
urlpatterns = [
    ...
    path("admin/workflow/users-organization/", dolphin_admin_site.admin_view(users_organization_workspace), name="users_organization_workspace"),
